...
const searchClient = algoliasearch('RWVG84PN0F', '9ff17254fca9d789a2bf14e6716783c2');
...
search.addWidgets([
    ...
    instantsearch.widgets.hits({
        ...
        <div>
          <div class="hit-name">
            {{#helpers.highlight}}{ "attribute": "accession_id" }{{/helpers.highlight}}
          </div>
          <div class="hit-description">
            {{#helpers.highlight}}{ "attribute": "haplotype" }{{/helpers.highlight}}
            <br/>
            {{#helpers.highlight}}{ "attribute": "submitter" }{{/helpers.highlight}}
            <br/>
            {{#helpers.highlight}}{ "attribute": "submission_date" }{{/helpers.highlight}}
          </div>
          <div>\{{country}}</div>
        </div>
      `,
