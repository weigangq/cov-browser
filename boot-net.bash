...
perl $dir_exe/hapnet.pl --genome $dir_exe/ref.gb --vcf $dir_exe/snps-ref.vcf --hap $dir_exe/imputed.aln --impute-log $dir_exe/impute.log 2> log
...
for i in $(seq 1 $end); do 
    ...
    perl $dir_exe/hapnet.pl --genome $dir_exe/ref.gb --vcf $dir_exe/snps-ref.vcf --hap $dir_file/boot-$i.aln --impute-log $dir_exe/impute.log 2> log
